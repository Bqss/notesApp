  ...
  <div class="mt-6  bg-white dark:bg-secondary-dark text-text-light dark:text-text-dark p-6 rounded-lg">
    <form action="" method="post">
      ...
      <div class="flex flex-col mt-6">
        ...
        <textarea name="body" id="body"  class="w-full  rounded-md resize-none bg-white dark:bg-secondary-dark text-sm p-2 px-4 border border-gray-300  focus:border-blue-500 " rows="10" required> <?= $note_text ?></textarea>
      </div>
