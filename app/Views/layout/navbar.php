    ...
    <nav class="transition-colors duration-300">
        <div class=" flex justify-between  mt-10 mx-auto bg-secondary-light dark:bg-secondary-dark px-5 py-4 rounded-lg items-center">
            ...
            <div class="flex item-center gap-4">
                <button @click="$store.theme.toggle()" x-data class="bg-theme-button-light dark:bg-theme-button-dark p-2 rounded-md" >
                ...
                <?php if ($isLoggedIn) : ?>
                    <div class="inline-flex items-center gap-3 relative" x-data="dropdown">
                        <button @click="toggle" aria-haspopup="true" :aria-expanded="show"  class="bg-[rgb(237,242,255)]  dark:bg-navButton-dark p-[0.4rem]  rounded-md ring-2 ring-transparent active:ring-white">
